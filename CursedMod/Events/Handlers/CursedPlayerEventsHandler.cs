...
public static class CursedPlayerEventsHandler
{
    ...
    public static event CursedEventManager.CursedEventHandler<PlayerEscapingPocketDimensionEventArgs> EscapingPocketDimension;
    ...
    internal static void OnPlayerEscapingPocketDimension(PlayerEscapingPocketDimensionEventArgs args)
    {
        if (!args.Player.CheckPlayer())
            return;
        
        EscapingPocketDimension.InvokeEvent(args);
    }
