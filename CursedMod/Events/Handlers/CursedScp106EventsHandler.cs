...
public static class CursedScp106EventsHandler
{
    ...
    public static event CursedEventManager.CursedEventHandler<Scp106AttackingEventArgs> Attacking; 
    ...
    internal static void OnAttacking(Scp106AttackingEventArgs args)
    {
        Attacking.InvokeEvent(args);
    }
}