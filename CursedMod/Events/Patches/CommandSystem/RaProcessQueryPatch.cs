...
public class RaProcessQueryPatch
{
    ...
    {
        List<CodeInstruction> newInstructions = CursedEventManager.CheckEvent<RaProcessQueryPatch>(175, instructions);
        ...
        int offset = newInstructions.FindIndex(x => x.Calls(AccessTools.Method(typeof(ICommand), nameof(ICommand.Execute)))) - 6;
