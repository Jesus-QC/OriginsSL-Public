// -----------------------------------------------------------------------
// <copyright file="ScpRoleMaxHealthFix.cs" company="CursedMod">
...
public class ScpRoleMaxHealthFix
{
    private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
    {
        ...
        newInstructions.InsertRange(0, new[]
        {
            ...
            new (OpCodes.Ldfld, AccessTools.Field(typeof(FpcStandardScp), nameof(FpcStandardScp._lastOwner))),
