...
public class CursedScp049Role : CursedFpcRole
{
    ...
    public void Resurrect(CursedPlayer player)
    {
        ...
        ownerHub.transform.position = ResurrectAbility.CastRole.FpcModule.Position;
        
        if (SenseAbility.DeadTargets.Contains(ownerHub))
        {
            HumeShieldModuleBase humeShieldModule = ResurrectAbility.CastRole.HumeShieldModule;
