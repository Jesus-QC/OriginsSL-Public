...
public class CursedScp106Role : CursedFpcRole
{
    ...
    public VigorStat Vigor => HuntersAtlasAbility.Vigor;
    ...
    {
        if (HuntersAtlasAbility.CastRole.Sinkhole.NormalizedState > 0f)
            return;
        if (!HuntersAtlasAbility.CastRole.Sinkhole.Cooldown.IsReady)
            return;
        ...
        Vector3 position2 = HuntersAtlasAbility.CastRole.FpcModule.Position;
